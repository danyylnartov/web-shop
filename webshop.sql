...
(21, 'Тестовая категория 2', 'testovaya-kategoriya-2', 20, '111', '222');
...
(2, 2, 's-2.jpg'),
(3, 2, 's-3.jpg'),
(6, 41, '7902ef9abd66e941255d4b54a5574ef2.jpg'),
(7, 41, 'c2a03c848be000686056db180cd23384.jpg');
...
(21, 9, 1, 1, 'Casio MRP-700-1AVEF', 300),
(22, 9, 1, 1, 'Casio MRP-700-1AVEF (Red)', 310),
(23, 9, 1, 1, 'Casio MRP-700-1AVEF (Dark Black)', 305),
(24, 9, 2, 1, 'Casio MQ-24-7BUL', 70),
(25, 9, 2, 3, 'Casio MQ-24-7BUL (Silver)', 80),
(26, 10, 2, 1, 'Casio MQ-24-7BUL', 61.6),
(27, 10, 7, 1, 'Q&Q Q956J302Y', 17.6),
(28, 10, 5, 1, 'Citizen BJ2111-08E', 440),
(29, 11, 2, 1, 'Casio MQ-24-7BUL', 61.6),
(30, 11, 2, 3, 'Casio MQ-24-7BUL (Silver)', 70.4),
(34, 13, 1, 1, 'Casio MRP-700-1AVEF', 264),
(35, 13, 3, 1, 'Casio GA-1000-1AER', 352),
(36, 13, 6, 1, 'Citizen AT0696-59E', 308),
(37, 14, 7, 2, 'Q&Q Q956J302Y', 516),
(38, 14, 8, 1, 'Royal London 41040-01', 2322),
(39, 14, 1, 1, 'Casio MRP-700-1AVEF', 7740),
(40, 15, 3, 1, 'Casio GA-1000-1AER', 10320);
...
(36, 21, 'Новый товар 1', 'novyy-tovar-1', '<p>Use&nbsp;<code>&lt;a&gt;</code>s or&nbsp;<code>&lt;button&gt;</code>s to create&nbsp;<em>actionable</em>&nbsp;list group items with hover, disabled, and active states by adding&nbsp;<code>.list-group-item-action</code>. We separate these pseudo-classes to ensure list groups made of non-interactive elements <strong>(like&nbsp;<code>&lt;li&gt;</code>s or&nbsp;<code>&lt;div&gt;</code>s) don&rsquo;t provide a click or tap affordance.</strong></p>\r\n', 100, 110, 1, '111', '222', 'no_image.jpg', 0),
(37, 21, 'Новый товар 1', 'novyy-tovar-1-37', '', 100, 0, 1, '', '', 'no_image.jpg', 0),
(38, 21, 'Новый товар 2', 'novyy-tovar-2', '<p><img alt=\"\" src=\"/public/upload/images/1/p-1.png\" style=\"float:left; height:200px; width:125px\" />Test</p>\r\n', 100, 0, 1, '', '', 'no_image.jpg', 0),
(39, 21, 'Новый товар 3', 'novyy-tovar-3', '', 100, 0, 1, '', '', 'no_image.jpg', 0),
(40, 21, 'Новый товар 4', 'novyy-tovar-4', 'Hi! This is product!', 100, 0, 1, '', '', 'no_image.jpg', 0),
(41, 21, 'Новый 5', 'novyy-5', '', 100, 0, 1, '', '', '42e042e87d40bec1b99f747e9e15f7e0.png', 0);
...
(2, 'User2Cool', '$2y$10$r5qwEanKbmfSL1ktdGGFRuc8AVWdBY4rC64e4jS/H0HvFRHuOvXmy', 'test2@gmail.com', 'Johny Depp', 'Улица Ленина, 58', 'user'),
(4, 'User3Cool', '$2y$10$.hdGcHA0hgQ5ukcYuPaUe.5fqnJgLoX/zPQqmG7xDeGrDo8aNjT0y', 'test3@gmail.com', 'Johny Marly Depp', 'Улица Ленина, 57', 'user'),
(5, 'User1', '$2y$10$pxokWWg3ULva0gN0xQCQLu4AVcmByFOzug27YfKgH8OOEO2l7/z46', 'tes123t@gmail.com', 'Ragnar', 'Kattegat', 'user'),
(6, 'user5', '$2y$10$6ohJpxSM2fWv/Ac6LIbgJueNUj4u2IMYwMVpKReahuz5J7C1G8KRG', 'test1234@gmail.com', 'Bjorn', 'Scandinavia', 'user'),
(7, 'user7', '$2y$10$zdPtY6DBhfvy0633ktq1CuEnaTofm.m4SYbz2RzGByBj/9x3FyOmq', 'test1234567@gmail.com', 'Bjorn', 'Scandinavia', 'user'),
