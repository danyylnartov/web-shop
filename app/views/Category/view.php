			...
			<div class="col-md-9 prdt-left">
				<?php if (!empty($products)): ?>
					<div class="product-one">
						<?php $curr = \webShop\App::$app->getProperty('currency'); ?>
							...
							<div class="col-md-4 product-left p-left">
								<div class="product-main simpleCart_shelfItem">
									...
									<div class="product-bottom">
										...
										<p>Explore Now</p>
										<h4>
											<a data-id="<?=$product->id;?>" class="add-to-cart-link" href="cart/add?<?=$product->id;?>"><i></i></a> <span class="item_price"><?=$curr['symbol_left'];?><?=$product->price * $curr['value'];?><?=$curr['symbol_right'];?></span>
